...
v1.08 : 修复灯光配置[2026-07-03] 
v1.09 : 运行前自动清空监控热文件夹；增加多语言支持[2026-07-07]
v1.10 : 标定图像导出[2026-07-10]，修改采集模式下图像输出编号命名方式以适配热文件夹下识别功能
v1.11 : 标定图像导出[2026-07-28]，增加采集时显示拼接图像功能
